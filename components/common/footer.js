				...
				<div className='flex flex-col items-center md:items-start'>
					...
					>
						<Image
							...
							alt='logo'
						></Image>
						<h2 className='ml-3 font-bold leading-5'>Pizza Tool</h2>
					</a>
					<div className='flex flex-wrap justify-center gap-x-2 md:gap-x-5 gap-y-1'>
						<a target='_blank' href="https://x.com/nil_0x">{React.createElement( FaXTwitter,{ className: 'text-base' })}</a>
						{/* <a href="#">{React.createElement( AiOutlineDiscord,{ className: 'text-base' })}</a> */}
						<a target='_blank' href="https://github.com/Nilin1/pizzatool">{React.createElement( FaGithub,{ className: 'text-base' })}</a>
						...
						<a target='_blank' href="https://docs.pizzatool.org">{React.createElement( BiSolidBookAlt,{ className: 'text-base' })}</a>
					</div>
				</div>
